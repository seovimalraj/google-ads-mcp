  ...
  return (
    <main style={containerStyle}>
      ...
      <section style={cardStyle}>
        ...
        <p>
          Call <InlineCode>GET {baseUrl}/api/mcp</InlineCode> to list the available tools. Responses
          include permissive CORS headers so you can hit the endpoint directly from ChatGPT. Here is
          an example payload:
        </p>
        <pre style={codeStyle}>
          {`{
